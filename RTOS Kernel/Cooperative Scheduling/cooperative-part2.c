...
// software loop delay for around 1 second 
void delay()
  {
	  uint32_t indexi, indexj;
     for(indexi=0;indexi<=3000;indexi++)
		   for(indexj=0;indexj<=5000;indexj++);
   }
